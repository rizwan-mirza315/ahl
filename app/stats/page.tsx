  ...
  return (
    <div className="space-y-10">
      <div className="border-b border-[#e5e5e5] pb-5">
        ...
        <h1 className="text-3xl sm:text-4xl font-black text-black tracking-tight">Player Stats</h1>
      </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#fafafa] border-b border-[#e5e5e5] text-[#999] text-[10px] tracking-[0.15em] uppercase">
                  ...
                  <th className="px-3 py-3 text-center font-bold hidden sm:table-cell">Pos</th>
                ...
                {scorers.map((player, i) => {
                  ...
                  return (
                    <tr key={player.id} className="border-b border-[#f0f0f0] last:border-0 hover:bg-[#fafafa] transition-colors">
                      <td className="px-4 py-3.5 text-[#bbb] font-bold">{i + 1}</td>
                      <td className="px-4 py-3.5 font-bold text-black">{player.name}</td>
                      ...
                      <td className="px-3 py-3.5 text-center text-[#999] hidden sm:table-cell">{player.position}</td>
                      <td className="px-3 py-3.5 text-center text-[#666]">{player.gamesPlayed}</td>
                      <td className="px-3 py-3.5 text-center text-[#666]">{player.goals}</td>
                      <td className="px-3 py-3.5 text-center text-[#666]">{player.assists}</td>
                      <td className="px-3 py-3.5 text-center font-black text-black text-base">{player.goals + player.assists}</td>
                    </tr>
                  );
                })}
              </tbody>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#fafafa] border-b border-[#e5e5e5] text-[#999] text-[10px] tracking-[0.15em] uppercase">
                  ...
                  <th className="px-3 py-3 text-center font-bold">GP</th>
                  <th className="px-3 py-3 text-center font-bold">G</th>
                  <th className="px-3 py-3 text-center font-black text-[#555]">A</th>
                </tr>
              </thead>
              <tbody>
                {topAssists.map((player, i) => {
                  ...
                  return (
                    <tr key={player.id} className="border-b border-[#f0f0f0] last:border-0 hover:bg-[#fafafa] transition-colors">
                      ...
                      <td className="px-3 py-3.5 text-center text-[#666]">{player.gamesPlayed}</td>
                      <td className="px-3 py-3.5 text-center text-[#666]">{player.goals}</td>
                      <td className="px-3 py-3.5 text-center font-black text-black text-base">{player.assists}</td>
                    </tr>
                  );
                })}
              </tbody>
