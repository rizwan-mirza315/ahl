  ...
  return (
    <div className="space-y-6">
      <div className="border-b border-[#e5e5e5] pb-5">
        ...
        <h1 className="text-4xl font-black text-black tracking-tight">Standings</h1>
      </div>
          ...
          <tbody>
            {rows.map((row, i) => (
              <tr key={row.team.id} className="border-b border-[#f0f0f0] last:border-0 hover:bg-[#fafafa] transition-colors">
                ...
                <td className="px-4 py-4 text-center text-[#666]">{row.gp}</td>
                <td className="px-4 py-4 text-center text-[#666]">{row.w}</td>
                <td className="px-4 py-4 text-center text-[#666]">{row.l}</td>
                <td className="px-4 py-4 text-center text-[#666]">{row.ot}</td>
                <td className="px-4 py-4 text-center text-[#666]">{row.gf}</td>
                <td className="px-4 py-4 text-center text-[#666]">{row.ga}</td>
                <td className="px-4 py-4 text-center font-black text-black text-base">{row.pts}</td>
              </tr>
            ))}
          </tbody>
        </table>
